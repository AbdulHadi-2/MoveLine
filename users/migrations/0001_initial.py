    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('driver', 'Driver'), ('worker', 'Worker'), ('admin', 'Admin')], default='customer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_preferences', models.CharField(blank=True, max_length=100)),
